/**
* @file Swiper插件
* @author 2014-2017 Vladimir Kharlampidi
* @version 4.0.1
*/
...
　　　　var updateAutoHeight = function () {
        ...
        var updateSlidesClasses = function () {
            ...
            + (params.slideNextClass) + ' ' + (params.slidePrevClass) + ' '
            + (params.slideDuplicateActiveClass) + ' ' + (params.slideDuplicateNextClass) + ' '
            + (params.slideDuplicatePrevClass)));
        
            var activeSlide;
            if (isVirtual) {
                activeSlide = swiper.$wrapperEl.find(('.' + (params.slideClass)
            ...
            if (params.loop) {
                ...
                if (nextSlide.hasClass(params.slideDuplicateClass)) {
                    $wrapperEl
                        .children(('.' + (params.slideClass) + ':not(.' + (params.slideDuplicateClass)
...
　　　　var transitionEnd$1 = function (runCallbacks) {
                ...
                if (params.centeredSlides) {
                    if (
                        ...
                        slideToIndex = $wrapperEl
                            .children(('.' + (params.slideClass) + '[data-swiper-slide-index="' + realIndex
                            + '"]:not(.' + (params.slideDuplicateClass) + ')'))
                            .eq(0)
                            .index();
            ...
            if (params.loopFillGroupWithBlank) {
                ...
                if (blankSlidesNum !== params.slidesPerGroup) {
                    for (var i = 0; i < blankSlidesNum; i += 1) {
                        var blankNode = $$1(document.createElement('div')).addClass(((params.slideClass) + ' '
        ...
        var onTouchMove = function (event) {
            ...
            if (typeof data.isScrolling === 'undefined') {
                ...
                || (swiper.isVertical() && touches.currentX === touches.startX)) {
                    ...
                    touchAngle = (Math.atan2(Math.abs(touches.currentY - touches.startY),
                    Math.abs(touches.currentX - touches.startX)) * 180) / Math.PI;
                    data.isScrolling = swiper.isHorizontal() ? touchAngle
                    > params.touchAngle : (90 - touchAngle > params.touchAngle);
                }
            }
            ...
            if ((diff > 0 && data.currentTranslate > swiper.minTranslate())) {
                ...
                if (params.resistance) {
                    data.currentTranslate = (swiper.minTranslate() - 1) + (Math.pow((-swiper.minTranslate()
                    + data.startTranslate + diff), resistanceRatio));
                }
            }
            else if (diff < 0 && data.currentTranslate < swiper.maxTranslate()) {
                disableParentSwiper = false;
                if (params.resistance) {
                    data.currentTranslate = (swiper.maxTranslate() + 1) - (Math.pow((swiper.maxTranslate()
                    - data.startTranslate - diff), resistanceRatio));
                }
            }
        ...
        var onTouchEnd = function (event) {
            ...
            // Return Grab Cursor
            if (params.grabCursor && data.isMoved && data.isTouched
            && (swiper.allowSlideNext === true
            || swiper.allowSlidePrev === true)) {
            ...
            if (!data.isTouched || !data.isMoved || !swiper.swipeDirection
            || touches.diff === 0 || data.currentTranslate === data.startTranslate) {
                data.isTouched = false;
                data.isMoved = false;
                return;
            }
        ...
        var Swiper$1 = (function (SwiperClass$$1) {
            function Swiper() {
                ...
                Utils.extend(swiper, {
                    ...
                    // RTL
                    rtl: swiper.params.direction === 'horizontal' && (el.dir.toLowerCase() === 'rtl'
        ...
        var Virtual = {
            update: function update(force) {
                ...
                if (force) {
                    ...
                    for (var i = previousFrom; i <= previousTo; i += 1) {
                        if (i < from || i > to) {
                            swiper.$wrapperEl.find(('.' + (swiper.params.slideClass)
                                + '[data-swiper-slide-index="' + i + '"]')).remove();
                        }
            ...
            renderSlide: function renderSlide(slide, index) {
                ...
                var $slideEl = params.renderSlide
                    ...
                    : $$1(('<div class="' + (swiper.params.slideClass) + '" data-swiper-slide-index="'
                    + index + '">' + slide + '</div>'));
        ...
        var Navigation = {
            ...
            init: function init() {
                ...
                if (params.nextEl) {
                    ...
                    if (
                        swiper.params.uniqueNavElements && typeof params.nextEl === 'string'
                        && $nextEl.length > 1 && swiper.$el.find(params.nextEl).length === 1
                    ) {
                ...
                if (params.prevEl) {
                    ...
                    if (
                        swiper.params.uniqueNavElements && typeof params.prevEl === 'string'
                        && $prevEl.length > 1 && swiper.$el.find(params.prevEl).length === 1
                    ) {
        ...
        var Navigation$1 = {
            ...
            on: {
                ...
                click: function click(e) {
                    ...
                    var $prevEl = ref.$prevEl;
                    if (
                        swiper.params.navigation.hideOnClick && !$$1(e.target).is($prevEl) && !$$1(e.target).is($nextEl)
                    ) {
                        if ($nextEl) {
        ...
        var Pagination = {
            update: function update() {
                ...
                var slidesLength = swiper.virtual
                && swiper.params.virtual.enabled ? swiper.virtual.slides.length : swiper.slides.length;
                ...
                if (params.type === 'bullets' && swiper.pagination.bullets && swiper.pagination.bullets.length > 0) {
                    ...
                    if (params.dynamicBullets) {
                        ...
                        = bullets.eq(0)[swiper.isHorizontal() ? 'outerWidth' : 'outerHeight'](true);
                    ...
                    if (params.dynamicBullets) {
                        var bulletsOffset = (((swiper.pagination.bulletSize * 5)
                        - (swiper.pagination.bulletSize)) / 2) - (current * swiper.pagination.bulletSize);
                ...
                if (params.type === 'progressbar') {
                    ...
                    $el.find(('.' + (params.progressbarFillClass))).transform(('translate3d(0,0,0) scaleX(' + scaleX
                    + ') scaleY(' + scaleY + ')')).transition(swiper.params.speed);
                }
            ...
            init: function init() {
                ...
                if (
                    swiper.params.uniqueNavElements && typeof params.el === 'string'
                    && $el.length > 1 && swiper.$el.find(params.el).length === 1
                ) {
        ...
        var Pagination$1 = {
            ...
            on: {
                ...
                click: function click(e) {
                    var swiper = this;
                    if (
                        swiper.params.pagination.el && swiper.params.pagination.hideOnClick
        ...
        var Scrollbar = {
            ...
            setDragPosition: function setDragPosition(e) {
                ...
                var pointerPosition;
                if (swiper.isHorizontal()) {
                    pointerPosition = ((e.type === 'touchstart'
                    || e.type === 'touchmove') ? e.targetTouches[0].pageX : e.pageX || e.clientX);
                }
                else {
                    pointerPosition = ((e.type === 'touchstart'
            ...
            init: function init() {
                ...
                var $el = $$1(params.el);
                if (swiper.params.uniqueNavElements && typeof params.el === 'string'
                && $el.length > 1 && $swiperEl.find(params.el).length === 1) {
        ...
        var Zoom = {
            ...
            onTouchEnd: function onTouchEnd() {
                ...
                gesture.$imageWrapEl.transition(momentumDuration).transform(('translate3d('
            ...
            enable: function enable() {
                ...
                && swiper.params.passiveListeners ? {passive: true, capture: false} : false;
        ...
        var Zoom$1 = {
            ...
            create: function create() {
                ...
                var str1 = 'onGestureStart onGestureChange onGestureEnd onTouchStart';
                var str2 = 'onTouchMove onTouchEnd onTransitionEnd toggle enable disable in out';
                var str = str1 + ' ' + str2;
        ...
        var Lazy = {
            loadImagesInSlide: function loadImagesInSlide(index, loadInDuplicate) {
                ...
                var $images = $slideEl.find(('.' + (params.elementClass)
                + ':not(.' + (params.loadedClass) + '):not(.' + (params.loadingClass) + ')'));
        ...
        var a11y = {
            ...
            updatePagination: function updatePagination() {
                ...
                && swiper.pagination.bullets.length) {
                    swiper.pagination.bullets.each(function (bulletIndex, bulletEl) {
                        ...
                        swiper.a11y.addElLabel($bulletEl,
            ...
            destroy: function destroy() {
                ...
                if (swiper.pagination && swiper.params.pagination.clickable && swiper.pagination.bullets
                && swiper.pagination.bullets.length) {
                    swiper.pagination.$el.off('keydown', ('.'
                    + (swiper.params.pagination.bulletClass)), swiper.a11y.onEnterKey);
                }
        ...
        var Fade = {
            setTranslate: function setTranslate() {
                ...
                for (var i = 0; i < slides.length; i += 1) {
                    ...
                    ? Math.max(1 - Math.abs($slideEl[0].progress), 0) : 1 + Math.min(Math.max($slideEl[0].progress, -1), 0);
                    $slideEl
                        .css({
        ...
        var Cube = {
            setTranslate: function setTranslate() {
                ...
                for (var i = 0; i < slides.length; i += 1) {
                    ...
                    if (params.slideShadows) {
                        ...
                        if (shadowBefore.length === 0) {
                            shadowBefore = $$1(('<div class="swiper-slide-shadow-'
                            + (isHorizontal ? 'left' : 'top') + '"></div>'));
                            $slideEl.append(shadowBefore);
                        }
        
                        if (shadowAfter.length === 0) {
                            shadowAfter = $$1(('<div class="swiper-slide-shadow-'
                ...
                if (params.shadow) {
                    if (isHorizontal) {
                        ...
                        + ((swiperWidth / 2) + params.shadowOffset) + 'px, '
                ...
                $wrapperEl
                    ...
                    + (swiper.isHorizontal() ? 0 : wrapperRotate) + 'deg) rotateY('
            ...
            setTransition: function setTransition(duration) {
                ...
                var $el = swiper.$el;
                var slides = swiper.slides;
                var str1 = '.swiper-slide-shadow-top, .swiper-slide-shadow-right,';
                var str2 = ' .swiper-slide-shadow-bottom, .swiper-slide-shadow-left';
                var str = str1 + ' ' + str2;
                slides
                    .transition(duration)
                    .find(str)
            ...
            setTranslate: function setTranslate() {
                ...
                for (var i = 0; i < slides.length; i += 1) {
                    ...
                    if (swiper.params.flipEffect.slideShadows) {
                        ...
                        if (shadowBefore.length === 0) {
                            shadowBefore = $$1(('<div class="swiper-slide-shadow-'
                            + (swiper.isHorizontal() ? 'left' : 'top') + '"></div>'));
                            $slideEl.append(shadowBefore);
                        }
        
                        if (shadowAfter.length === 0) {
                            shadowAfter = $$1(('<div class="swiper-slide-shadow-'
                            + (swiper.isHorizontal() ? 'right' : 'bottom') + '"></div>'));
                            $slideEl.append(shadowAfter);
                        }
        ...
        var Coverflow = {
            setTranslate: function setTranslate() {
                ...
                for (var i = 0, length = slides.length; i < length; i += 1) {
                    ...
                    var slideTransform = 'translate3d(' + translateX + 'px,' + translateY + 'px,'
                    + translateZ + 'px)  rotateX(' + rotateX + 'deg) rotateY(' + rotateY + 'deg)';
                    ...
                    if (params.slideShadows) {
                        ...
                        if ($shadowBeforeEl.length === 0) {
                            $shadowBeforeEl = $$1(('<div class="swiper-slide-shadow-'
                            + (isHorizontal ? 'left' : 'top') + '"></div>'));
                            $slideEl.append($shadowBeforeEl);
                        }
        
                        if ($shadowAfterEl.length === 0) {
                            $shadowAfterEl = $$1(('<div class="swiper-slide-shadow-'
                            + (isHorizontal ? 'right' : 'bottom') + '"></div>'));
